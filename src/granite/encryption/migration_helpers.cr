module Granite::Encryption
  ...
  module MigrationHelpers
    ...
    def self.encrypt_column(
      model_class : Granite::Base.class,
      attribute : Symbol,
    ...
    # Example:
    #   puts Granite::Encryption::MigrationHelpers.generate_migration(User, :ssn)
    def self.generate_migration(model_class : Granite::Base.class, attribute : Symbol) : String
