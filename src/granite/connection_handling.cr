...
module Granite
  # Provides connection handling and switching capabilities
  module ConnectionHandling
    ...
    # The connection pooling is handled internally by crystal-db
    # through the adapters, so we don't need a separate pool wrapper
  end
end