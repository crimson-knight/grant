# Dirty tracking functionality is built directly into Granite::Base and Granite::Columns.
#
...
#
# See `Granite::Base` for the core dirty tracking methods and `Granite::Columns` 
...
module Granite::Dirty
  ...
  # directly into Granite::Base and Granite::Columns for better performance
