module Grant
  ...
  class Connections
    ...
    def self.<<(data : NamedTuple(name: String, reader: String, writer: String, adapter_type: Grant::Adapter::Base.class)) : Nil
      # Register writer
      ConnectionRegistry.establish_connection(
        database: data[:name],
    ...
    def self.[](name : String) : {writer: Grant::Adapter::Base, reader: Grant::Adapter::Base}?
    ...
    def self.registered_connections
      result = [] of {writer: Grant::Adapter::Base, reader: Grant::Adapter::Base}
