...
describe "Grant::ConvenienceMethods" do
  ...
  describe ".insert_all" do
    ...
    it "handles empty array" do
      records = ConvenienceUser.insert_all([] of Hash(String, Grant::Columns::Type))
  ...
  describe "#sole" do
    ...
    it "raises NotFound when no records exist" do
      expect_raises(Grant::Querying::NotFound, "No ConvenienceUser found") do
    ...
    it "raises NotUnique when multiple records exist" do
      ...
      expect_raises(Grant::Querying::NotUnique, "Multiple ConvenienceUser records found") do
        ConvenienceUser.sole
      end
    end
