...
describe "#find_by, #find_by!" do
  ...
  it "works with multiple arguments" do
    ...
    expect_raises(Grant::Querying::NotFound, /No .*Review.* found where name = review1 and upvotes = 20/) do
  ...
  it "returns nil or raises if no result" do
    ...
    expect_raises(Grant::Querying::NotFound, /No .*Parent.* found where name = xxx/) do
