...
describe "Granite::Associations::Options" do
  describe "dependent options" do
    ...
    describe "dependent: :restrict" do
      it "prevents deletion when dependent records exist" do
        ...
        expect_raises(Granite::RecordNotDestroyed) do
          team.destroy!
        end
...
class DependentAuthor < Granite::Base
  connection sqlite
...
class DependentPost < Granite::Base
  connection sqlite
...
class NullifyCategory < Granite::Base
  connection sqlite
...
class NullifyArticle < Granite::Base
  connection sqlite
...
class RestrictTeam < Granite::Base
  connection sqlite
...
class RestrictMember < Granite::Base
  connection sqlite
...
class OptionalCategory < Granite::Base
  connection sqlite
...
class OptionalItem < Granite::Base
  connection sqlite
...
class RequiredItem < Granite::Base
  connection sqlite
...
class CounterBlog < Granite::Base
  connection sqlite
  table counter_blogs
...
class CounterPost < Granite::Base
  connection sqlite
  table counter_posts
...
class TouchProfile < Granite::Base
  connection sqlite
