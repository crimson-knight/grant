...
describe "Granite::Associations::Polymorphic - Edge Cases" do
  ...
  describe "proxy behavior" do
    it "reloads associations" do
      proxy = Granite::Polymorphic::PolymorphicProxy.new("EdgePost", 999_i64)
    ...
    it "correctly identifies present associations" do
      ...
      proxy1 = Granite::Polymorphic::PolymorphicProxy.new("EdgePost", 123_i64)
      proxy1.present?.should be_true
      
      # With only type
      proxy2 = Granite::Polymorphic::PolymorphicProxy.new("EdgePost", nil)
...
{% begin %}
  ...
  class EdgeComment < Granite::Base
  ...
  class EdgeStrictComment < Granite::Base
    connection {{ adapter_literal }}
  ...
  # Custom column names
  class EdgeCustomItem < Granite::Base
    connection {{ adapter_literal }}
  ...
  class EdgeArticle < Granite::Base
    connection {{ adapter_literal }}
    table edge_articles
  ...
  class EdgeInvalidPK < Granite::Base
    connection {{ adapter_literal }}
  ...
  class EdgeDestroyPost < Granite::Base
    connection {{ adapter_literal }}
  ...
  class EdgeNullifyPost < Granite::Base
    connection {{ adapter_literal }}
