...
Granite::Adapter::Sqlite.new(name: "sqlite", url: "sqlite3://./spec_test_encryption.db").open do |db|
...
class EncryptedUser < Granite::Base
  connection sqlite
...
describe "Granite::Encryption Database Integration" do
