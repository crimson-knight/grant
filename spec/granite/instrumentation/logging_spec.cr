...
describe "Granite::Logging" do
  ...
  before_each do
    ...
    Log.setup do |c|
      ...
      c.bind "granite.sql", :trace, backend
      c.bind "granite.model", :trace, backend
      c.bind "granite.association", :trace, backend
      c.bind "granite.transaction", :trace, backend
  ...
  describe "Development helpers" do
    it "sets up all logging categories" do
      ...
      Granite::Logs::SQL.should be_a(Log)
      Granite::Logs::Model.should be_a(Log)
      Granite::Logs::Association.should be_a(Log)
      Granite::Logs::Transaction.should be_a(Log)
      Granite::Logs::Query.should be_a(Log)
    end
    
    it "can set up individual log categories" do
      Granite::Development.setup_sql_logging
      Granite::Development.setup_model_logging
      Granite::Development.setup_association_logging
      Granite::Development.setup_transaction_logging
      Granite::Development.setup_query_logging
