...
class SomeClass
  def initialize(@model_class : Grant::Base.class); end
...
describe Grant::Base do
  it "class methods should work when type restricted to `Grant::Base`" do
